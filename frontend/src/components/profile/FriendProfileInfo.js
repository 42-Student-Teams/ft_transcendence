// /src/components/profile/FriendProfileInfo.js
            ...
            const view = /*html*/ `
                <div class="card shadow-sm rounded mb-4">
                    <div class="d-flex flex-column align-items-center p-4">
                        <img src="${data.avatar || 'https://via.placeholder.com/80'}" alt="Profile" class="img-fluid rounded-circle mb-3" id="profile-picture">
                        <div class="text-center">
                            <h5 class="mb-1 font-weight-bold">${data.prenom} ${data.nom}</h5>
